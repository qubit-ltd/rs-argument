...
where
    T: NumericValue,
{
    RangeConstraint::new(capture_argument_bound(lower_bound), capture_argument_bound(upper_bound))
}
...
fn range_contains<T>(lower_bound: Bound<T>, upper_bound: Bound<T>, actual: T) -> bool
where
    T: NumericValue,
{
